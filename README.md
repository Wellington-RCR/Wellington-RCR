...
![dbt](https://img.shields.io/badge/dbt-Em%20formação-orange?style=flat-square&logo=dbt&logoColor=white)
...
- **dbt Fundamentals** — dbt Labs (em andamento)
- **BigQuery for Data Analysts** — Google / Coursera (em andamento)
- Data Warehousing — Star Schema e modelagem dimensional (Kimball)
